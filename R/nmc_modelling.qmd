...
```{r plot}
#| fig-cap: "**Figure S1.** Text TBD"

plot(est ~ temp_c, data = SPEEDS)

#png(filename="/Users/michaelnoonan/Dropbox/UBC/Grants/2023_Caribou_Collaring/year_1_report/NMC_data.png", width = 4, height = 6, units = "in", res = 600)
```

```{r plot}
#| fig-cap: "**Figure S2.** Text TBD"
